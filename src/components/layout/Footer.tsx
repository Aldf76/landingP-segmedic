  ...
  return (
    <footer className="border-t bg-slate-50">
      <div className="container mx-auto grid gap-8 px-4 py-12 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm">
            <li><a href="#benefits" className="text-slate-600 hover:underline">Benefícios</a></li>
            <li><a href="#how-it-works" className="text-slate-600 hover:underline">Como funciona</a></li>
            <li><a href="#testimonials" className="text-slate-600 hover:underline">Depoimentos</a></li>
            <li><a href="#faq" className="text-slate-600 hover:underline">FAQ</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm">
            ...
            <li><a href="#lead" className="text-slate-600 hover:underline">Fale conosco</a></li>
          </ul>
        </div>
      ...
      <div className="border-t">
        <div className="container mx-auto flex flex-col items-center justify-between gap-2 px-4 py-6 text-xs text-slate-500 md:flex-row">
